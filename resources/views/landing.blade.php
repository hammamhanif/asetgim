                        ...
                        <div class="col-md-12">
                            <div id="site-header-inner">
                                <div id="site-logo" class="clearfix">
                                    <div id="site-logo-inner">
                                        <a href="index.html" rel="home" class="main-logo">
                                            <img id="logo_header" src="{{ asset('images/logo/logo_dark.png') }}"
                                                alt="Image">
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            <li class="menu-item menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item"><a href="home2.html">Home 2</a>
                                                    </li>
                                                ...
                                                <ul class="sub-menu">
                                                    <li class="menu-item">
                                                        ...
                                                        <ul class="sub-menu menu-item-has-children right-sub-menu ">
                                                            <li class="menu-item"><a href="inventory.html">Dashboard
                                                                    Inventory</a></li>
                                                            <li class="menu-item"><a href="wallet-board.html">Dashboard
                                                                    Wallet</a></li>
                                                            <li class="menu-item"><a href="history-board.html">Dashboard
                                                                    History</a></li>
                                                            <li class="menu-item"><a href="follow-board.html">Dashboard
                                                                    Following</a></li>
                                                            <li class="menu-item"><a
                                                                    href="favorite-board.html">Dashboard Favorites</a>
                                                            </li>
                                                            <li class="menu-item"><a
                                                                    href="edit-profile-board.html">Dashboard Edit
                                                                    Profile 1</a></li>
                                                            <li class="menu-item"><a
                                                                    href="edit-profile-board2.html">Dashboard Edit
                                                                    Profile 2</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="menu-item"><a href="ranking.html">Ranking</a></li>
                                                    <li class="menu-item"><a href="help-center.html">Help Center</a>
                                                    </li>
                                                    <li class="menu-item"><a href="faq.html">FAQ</a></li>
                                                    <li class="menu-item"><a href="connect-wallet.html">Connect
                                                            Wallet</a></li>
                                            ...
                                            <li class="menu-item menu-item-has-children ">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item"><a href="blog-details.html">Blog Details
                                                            1</a></li>
                                                    <li class="menu-item"><a href="blog-details2.html">Blog Details
                                                            2</a></li>
                                                </ul>
                                            </li>
                                ...
                                <div class="header-right">
                                    ...
                                    <span class="user "><svg width="20" height="18" viewBox="0 0 20 18"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <mask id="mask0_2981_49321" style="mask-type:alpha"
                                                maskUnits="userSpaceOnUse" x="0" y="11" width="16"
                                                height="7">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M0 11.2949H15.1998V18.0009H0V11.2949Z" fill="white" />
                                            </mask>
                                            ...
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                fill="#B9B8BB" />
                                            <mask id="mask1_2981_49321" style="mask-type:alpha"
                                                maskUnits="userSpaceOnUse" x="15" y="10" width="5"
                                                height="6">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <a href="#" onclick="switchTheme()" class="mode-switch">
                                        <img id="img-mode" src="{{ asset('images/icon/moon.png') }}" alt="Image">
                                    </a>
                                </div>
                                        ...
                                        <div class="slider-item">
                                            <div class="tf-slider-item style-2">
                                                <div class="content-inner">
                                                    <h1 class="heading">
                                                        Defind, Coll<span>ect</span> and Sell Sup<span>er</span> Rate
                                                        NFT
                                                        <img src="{{ asset('images/slider/bg-slider-3.png') }}"
                                                            alt="Image">
                                                    </h1>
                                                    ...
                                                    <div class="btn-slider ">
                                                        <a href="explore-banner.html"
                                                            class="tf-button style-2">Explore now</a>
                                                        <a href="add-NFT.html" class="tf-button style-3">Start Now</a>
                                                    </div>
                                                </div>
                                                <div class="image">
                                                    <div class="sc-product style3 ">
                                                        <div class="features">
                                                            <div class="product-media">
                                                                <img src="{{ asset('images/product/product26.jpg') }}"
                                                                    alt="images">
                                                            </div>
                                                        </div>
                                                        <div class="content">
                                                            ...
                                                            <div class="details-product">
                                                                <div class="title"> <a href="item-details.html">“The
                                                                        Monkey sad ”</a> </div>
                                                                <div class="creator"> <a
                                                                        href="#">@SolvadorDali</a> </div>
                                                            </div>
                                                            <div class="price">
                                                    ...
                                                    <img src="{{ asset('images/slider/bg-slider-4.png') }}"
                                                        alt="Image" class="img-slider-2">
                                                </div>
                                            </div>
                                        </div><!-- item-->
                                    </div>
            ...
            <section class="tf-section tf-category">
                <div class="tf-container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="swiper-container product-category wow fadeInUp">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="tf-product-category">
                                                <img src="{{ asset('images/product-category/product-category-1.jpg') }}"
                                                    alt="Image">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="tf-product-category">
                                                <img src="{{ asset('images/product-category/product-category-2.jpg') }}"
                                                    alt="Image">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="tf-product-category">
                                                <img src="assets/images/product-category/product-category-3.jpg"
                                                    alt="Image">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="tf-product-category">
                                                <img src="assets/images/product-category/product-category-4.jpg"
                                                    alt="Image">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="tf-product-category">
                                                <img src="assets/images/product-category/product-category-1.jpg"
                                                    alt="Image">
                                                <div class="category"><a href="#">Digital art</a></div>
                                            </div>
                                        </div><!-- item-->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="tf-product-category">
                                                <img src="assets/images/product-category/product-category-2.jpg"
                                                    alt="Image">
                                                <div class="category"><a href="#">Style</a></div>
                                            </div>
                                        </div><!-- item-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tf-heading mb40 wow fadeInUp">
                                ...
                                <a class="button" href="live-auction.html">Explore<i
                                        class="fal fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="swiper-container live-auction visible wow fadeInUp">
                                <div class="swiper-wrapper ">
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="sc-product style1">
                                                ...
                                                <div class="bottom">
                                                    <div class="details-product">
                                                        <div class="author">
                                                            <div class="avatar">
                                                                <img src="assets/images/author/author1.png"
                                                                    alt="images">
                                                            </div>
                                                            <div class="content">
                                                        ...
                                                        <div class="current-bid">
                                                            <div class="subtitle">Current bid</div>
                                                            <div class="price">
                                                                <span class="cash">5 ETH</span><span
                                                                    class="icon"><img
                                                    ...
                                                    <div class="product-button">
                                                        <a href="#" data-toggle="modal"
                                                            data-target="#popup_bid" class="tf-button"> <span
                                                                class="icon-btn-product"></span> details</a>
                                                    </div>
                                            ...
                                            <div class="sc-product style1">
                                                ...
                                                <div class="bottom">
                                                    <div class="details-product">
                                                        <div class="author">
                                                            <div class="avatar">
                                                                <img src="assets/images/author/author14.png"
                                                                    alt="images">
                                                            </div>
                                                            <div class="content">
                                                                <div class="position">Creator</div>
                                            ...
                                            <div class="sc-product style1">
                                                ...
                                                <div class="bottom">
                                                    <div class="details-product">
                                                        <div class="author">
                                                            <div class="avatar">
                                                                <img src="assets/images/author/author15.png"
                                                                    alt="images">
                                                            </div>
                                                            <div class="content">
                                                                <div class="position">Creator</div>
                                            ...
                                            <div class="sc-product style1">
                                                ...
                                                <div class="bottom">
                                                    <div class="details-product">
                                                        <div class="author">
                                                            <div class="avatar">
                                                                <img src="assets/images/author/author16.png"
                                                                    alt="images">
                                                            </div>
                                                            <div class="content">
                                                                <div class="position">Creator</div>
                                            ...
                                            <div class="sc-product style1">
                                                ...
                                                <div class="bottom">
                                                    <div class="details-product">
                                                        <div class="author">
                                                            <div class="avatar">
                                                                <img src="assets/images/author/author17.png"
                                                                    alt="images">
                                                            </div>
                                                            <div class="content">
                                                                <div class="position">Creator</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="tf-create wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <p class="content">Sed Ut Perspiciatis Unde Omnis Iste Natus Error Sit Voluptatem
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tf-heading mb30 wow fadeInUp">
                                ...
                                <a class="button style-2" href="collection.html">Explore<i
                                        class="fal fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="collection-carousel">
                                <div class="swiper-container product-category-1 pt10 wow fadeInUp">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="slider-item">
                                                <div class="sc-product style1 collection">
                                                    <a href="#">
                                                        <div class="thumb-collection">
                                                            <div class="left-thumb">
                                                                <img src="assets/images/collection/collection1.jpg"
                                                                    alt="images">
                                                            </div>
                                                            <div class="right-thumb">
                                                                <div class="top-cl">
                                                                    <img src="assets/images/collection/collection2.jpg"
                                                                        alt="images">
                                                                </div>
                                                                <div class="bottom-cl">
                                                                    <img src="assets/images/collection/collection3.jpg"
                                                                        alt="images">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="tf-author">
                                                        <div class="image">
                                                            <img src="assets/images/author/author-cl.png"
                                                                alt="Image">
                                                            <svg width="12" height="12" viewBox="0 0 16 16"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path class="fill-svg" fill-rule="evenodd"
                                                                    clip-rule="evenodd"
                                                    ...
                                                    <div class="top">
                                                        <div class="content">
                                                            <div class="details"><span><img
                                                                        src="assets/images/icon/ethe.svg"
                                                                        alt="images"></span> <a
                                                                    href="#">33.2 wETH</a> </div>
                                            ...
                                            <div class="slider-item">
                                                <div class="sc-product style1 collection">
                                                    <a href="#">
                                                        <div class="thumb-collection">
                                                            <div class="left-thumb">
                                                                <img src="assets/images/collection/collection4.jpg"
                                                                    alt="images">
                                                            </div>
                                                            <div class="right-thumb">
                                                                <div class="top-cl">
                                                                    <img src="assets/images/collection/collection5.jpg"
                                                                        alt="images">
                                                                </div>
                                                                <div class="bottom-cl">
                                                                    <img src="assets/images/collection/collection6.jpg"
                                                                        alt="images">
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="slider-item">
                                                <div class="sc-product style1 collection">
                                                    <a href="#">
                                                        <div class="thumb-collection">
                                                            <div class="left-thumb">
                                                                <img src="assets/images/collection/collection7.jpg"
                                                                    alt="images">
                                                            </div>
                                                            <div class="right-thumb">
                                                                <div class="top-cl">
                                                                    <img src="assets/images/collection/collection8.jpg"
                                                                        alt="images">
                                                                </div>
                                                                <div class="bottom-cl">
                                                                    <img src="assets/images/collection/collection9.jpg"
                                                                        alt="images">
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="slider-item">
                                                <div class="sc-product style1 collection">
                                                    <a href="#">
                                                        <div class="thumb-collection">
                                                            <div class="left-thumb">
                                                                <img src="assets/images/collection/collection10.jpg"
                                                                    alt="images">
                                                            </div>
                                                            <div class="right-thumb">
                                                                <div class="top-cl">
                                                                    <img src="assets/images/collection/collection11.jpg"
                                                                        alt="images">
                                                                </div>
                                                                <div class="bottom-cl">
                                                                    <img src="assets/images/collection/collection12.jpg"
                                                                        alt="images">
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="row tf-filter-container wow fadeInUp">
                                ...
                                <div class="content">
                                    ...
                                    <div class="profile-author">
                                        <a href="#" class="avatar" data-tooltip="Creator: Daniel Jordan"
                                            tabindex="0"><img src="assets/images/author/authorpd14.png"
                                                alt="images"></a>
                                        <a href="#" class="avatar" data-tooltip="Creator: Daniel Rose"
                                            tabindex="0"><img src="assets/images/author/authorpd15.png"
                                                alt="images"></a>
                                        <a href="#" class="avatar" data-tooltip="Creator: Solvador"
                                            tabindex="0"><img src="assets/images/author/authorpd16.png"
                                                alt="images"></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 tf-loadmore 3d abstract">
                            <div class="sc-product style3">
                                ...
                                <div class="content">
                                    <div class="details-product">
                                        <div class="title"> <a href="item-details.html">“Valentine Romero”</a>
                                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4">
                            <div class="widget widget-subcribe">
                                ...
                                <form action="#" id="subscribe-form">
                                    <input type="email" placeholder="Info@yourgmail.com" required=""
                                        id="subscribe-email">
