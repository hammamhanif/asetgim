                                ...
                                <div id="site-logo" class="clearfix">
                                    <div id="site-logo-inner">
                                        <a href="index.html" rel="home" class="main-logo">
                                            <img id="logo_header" src="{{ asset('images/logo/logo_dark.png') }}" alt="Image">
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            <div class="tf-slider-item style-2">
                                                <div class="content-inner">
                                                    <h1 class="heading">
                                                        ...
                                                        <img src="{{ asset('images/slider/bg-slider-3.png') }}" alt="Image">  
                                                    </h1>
                                                ...
                                                <div class="image">
                                                    <div class="sc-product style3 ">
                                                        <div class="features">
                                                            <div class="product-media">
                                                                <img src="{{ asset('images/product/product26.jpg') }}" alt="images">
                                                            </div>
                                                        </div>
                                                        <div class="content">
                                                    ...
                                                    <img src="{{ asset('images/slider/bg-slider-4.png') }}" alt="Image" class="img-slider-2">
                                                </div>
                                            </div>
                                        </div><!-- item-->
                                    </div>
                            ...
                            <div class="swiper-container product-category wow fadeInUp">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="tf-product-category">
                                                <img src="{{ asset('images/product-category/product-category-1.jpg') }}" alt="Image">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slider-item">
                                            <div class="tf-product-category">
                                                <img src="{{ asset('images/product-category/product-category-2.jpg') }}" alt="Image">
