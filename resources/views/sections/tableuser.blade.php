                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form text-left"
                                                    action="{{ route('tableuser.update', $user->id) }}" method="post"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="name"
                                                            name="name" value="{{ htmlentities($user->name) }}"
                                                            readonly>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="username" class="col-form-label">Username:</label>
                                                        <input type="text" class="form-control" id="username"
                                                            name="username" value="{{ htmlentities($user->username) }}"
                                                            readonly>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="email" class="col-form-label">Email:</label>
                                                        <input type="text" class="form-control" id="email"
                                                            name="email" value="{{ htmlentities($user->email) }}"
                                                            readonly>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="type" class="col-form-label">Tipe
                                                            Akun</label>
                                                        <select class="form-select form-select-md"
                                                            aria-label=".form-select-md example" name="type"
                                                            id="type">
                                                            <option @if ($user->type === 'admin') selected @endif
                                                                value="admin">Admin</option>
                                                            <option @if ($user->type === 'creator') selected @endif
