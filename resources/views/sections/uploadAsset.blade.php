                            ...
                            <ul class="create-button menu-tab">
                                <li class="active">
                                    <div class="create-item">
                                        <div class="icon"><svg width="20" height="20" viewBox="0 0 20 20"
                                ...
                                <li>
                                    <div class="create-item">
                                        <div class="icon"><svg width="25" height="24" viewBox="0 0 25 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="content-tab">
                                <div class="content-inner active">
                                    <div class="tab-create-item">
                                        ...
                                        <p class="sub">But Each One Takes A Different Approach And Makes Different
                                            Tradeoffs.</p>
                                        ...
                                        <ul class="collection-list">
                                            ...
                                            <li>
                                                <div class="list">
                                                    <div class="infor">
                                                        <p>Account support</p>
                                                        <h6>Receive messages about your account, your trips, legal alerts
                                                        </h6>
                                                    </div>
                                                    <div class="button-toggle">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <div class="sc-product style1">
                        ...
                        <div class="bottom">
                            ...
                            <div class="product-button">
                                <a href="#" data-toggle="modal" data-target="#popup_bid" class="tf-button"> <span
