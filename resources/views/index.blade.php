...
<head>
    ...
    <title>GANA | Game Asset Nusantara</title>
                                ...
                                <div class="header-right">
                                    ...
                                    <span class="user "><svg width="20" height="18" viewBox="0 0 20 18"
                                            ...
                                            <mask id="mask1_2981_49321" style="mask-type:alpha"
                                                maskUnits="userSpaceOnUse" x="15" y="10"
                                                width="5" height="6">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <div class="tf-slider-item">
                                                ...
                                                <div class="image">
                                                    <div class="img-slider-main ani5"><img
                                                            src="assets/images/slider/slider-1.jpg" alt="Image">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- item-->
                                                    ...
                                                    <div class="product-button">
                                                        <a href="#" data-toggle="modal"
                                                            data-target="#popup_bid" class="tf-button"> <span
                                                                class="icon-btn-product"></span> Place Bid</a>
                                                    </div>
